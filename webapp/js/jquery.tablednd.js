 ...
 * set up various options to control how the system will work Copyright © Denis
 * Howlett <denish@isocra.com> Licensed like jQuery, see
 ...
 * can't assign a borderâ€”well you can, but it won't be displayed). (So instead
...
this.tableDnDConfig = {
		...
		jQuery(document).bind('mousemove', jQuery.tableDnD.mousemove).bind(
				'mouseup', jQuery.tableDnD.mouseup);
