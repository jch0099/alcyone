  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12">
        ...
        <a href="#register" class="btn btn-default smoothScroll">register</a>
        <a href="#login" class="btn btn-default smoothScroll">log in</a>
        <a href="#index" class="btn btn-default smoothScroll">Ignore</a></div>
    </div>
  </div>
</section>
</c:if>
